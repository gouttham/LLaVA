deepspeed /localscratch/gna23/LLaVA/llava/train/train_mem.py \
    ...
    --validation_data_path /localscratch/gna23/LLaVA/dataset/validation/dataset.json \
    ...
    --bf16 True \
    --output_dir /localscratch/gna23/LLaVA/llava/checkpoints/llama-2-7b-chat-task-qlora \
